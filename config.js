...
const windmillConfig = {
  ...
  purge: {
    content: [
      'node_modules/@talkiiing/ui/lib/defaultTheme.js',
      'node_modules/@talkiiing/ui/dist/index.js',
    ],
  },
  theme: {
    colors,
...
/**
 * Merge Talkiiing UI and Tailwind CSS configurations
 * @param {object} tailwindConfig - Tailwind config object
 * @return {object} new config object
 */
function merge(tailwindConfig) {
  let purge
